...
/* 
  ...
  1. Jelaskan mengapa program di atas tidak bisa dijalankan (memiliki error/exception)
     Jawab : Terdapat fungsi sleep() Sehingga program tidak bisa dijalankan karena tidak adanya IntterruptedException pada saat menggunakan .
  
  
  2. Jelaskan dan terapkan bagaimana cara mengatasinya. Kemudian, kumpulkan program dalam keadaan sudah bisa dijalankan
     Jawab : Dapat menggunakan try and catch dalam menghandle InterruptedException.
  
  
  3. Jelaskan secara singkat algoritma program di atas
    Jawab : 
    Program ini membuat 2 thread yaitu thread-0 dan thread-1.
        1. Thread-0 --> mencetak # mulai dari i=1 sampai i=10 kali, dengan mencetak # sebanyak i pada setiap perulangan.
        2. Thread-1 --> mencetak > mulai dari i=1 sampai i=5 kali, dengan mencetak > sebanyak i pada setiap perulangan.
*/